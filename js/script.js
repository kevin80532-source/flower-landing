...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Animasi untuk Header Testimoni
  const testimoniHeader = document.querySelector(".testimoni-header");
  ...
  if (testimoniHeader) {
    ...
    headerObserver.observe(testimoniHeader);
  }

  // Animasi untuk Kartu Testimoni
  ...
  if (testimoniCards.length > 0) {
    ...
    testimoniCards.forEach((card) => cardObserver.observe(card));
  }
});
